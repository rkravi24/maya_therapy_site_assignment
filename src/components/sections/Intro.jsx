        ...
        <section className="bg-primary py-20">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-16 px-6 md:px-16">
                ...
                <div className="max-w-xl mx-auto md:mx-0 order-2 md:order-1">
                    ...
                    <a
                        href="#"
                        className="inline-flex items-center gap-2 border border-textDark px-8 py-4
                        text-sm uppercase tracking-wider text-textDark transition-all duration-300 hover:bg-textDark hover:text-white">
                        Let’s chat →
                    </a>
                </div>
                ...
                <div className="relative flex justify-center order-1 md:order-2">
                    ...
                    <div className="relative w-72 md:w-100 h-105 md:h-150 overflow-hidden rounded-t-full">
                        <Image src="/doctor.png" alt="Therapy lifestyle imagery" fill className="object-cover" priority />
                    </div>
